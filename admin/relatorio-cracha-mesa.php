...
<head>
  ...
  <title>Crachás</title>
  <link href="css/cracha-mesa.css" rel="stylesheet">
</head>
<body>
  ...
  echo '<div class="secao-cracha">';
    ...
    // }
      ...
      $row = $result->fetch_array();
        ...
        if ($confirmado == 1) {
    echo '<div class="cracha-mesa">
      <div class="cracha-mesa-ladoa invertido" style="border-style: double;
      border-width  : 5px;
    ...
    echo '
    <div class="cracha-mesa-ladoa" style="border-style: double;
    border-width: 5px;
    border-color: '.$circulo_cor.';">
      <div class="cracha-nomes">
        <div class="cracha-nome-grande">
